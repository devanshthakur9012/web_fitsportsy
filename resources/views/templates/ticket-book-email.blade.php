                                                    ...
                                                    <tr>
                                                        <td role="modules-container"
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                data-type="columns" style="padding:30px 20px 30px 20px;"
                                                                bgcolor="#f6f6f6" data-distribution="1">
                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                                                            ...
                                                                                                            <img class="max-width"
                                                                                                                ...
                                                                                                                src="{{asset('images/upload/'.Common::siteGeneralSettings()->logo)}}"
                                                                                                                height="27">
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                                        ...
                                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                                    <span
                                                                                                                        style="font-size: 18px">Please view you ticket details by clicking on View Ticket button
                                                                                                                       </span>
                                                                                                                       <span
