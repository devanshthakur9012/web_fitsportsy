                    ...
                    <form method="post" action="{{ route("users.update", [$user->id]) }}">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-5">
                                @php
                                    $encLink = url('organizer-code-scan/'.Common::encryptId($user->id));
                                  
                                @endphp
                                <a href="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(500)->generate($encLink)) !!}" download="organizer_qr_code_{{$user->id}}">
                                    <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(190)->generate($encLink)) !!}">
                                    <br><button type="button" class="btn btn-primary btn-sm">Download QR Code</button>
                                </a>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" value="{{$user->name.' '.$user->first_name}}" class="form-control @error('first_name')? is-invalid @enderror">
                                    @error('first_name')
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$user->address}}" name="address" placeholder="{{__('Address')}}" value="{{old('address')}}" class="form-control @error('address')? is-invalid @enderror">
                                    @error('address')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @endif
                                </div>
