...
<section class="page-wrapper">
    <div class="content container-fluid">
        @include('user.coach-booking.edit-top-bar',['bookData' => $bookData,'type' => 'book_info'])
        @include('messages')
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <ul class="amenities">
                                            @php
                                                $exAmenities = json_decode($bookData->sports_available, true);
                                            @endphp
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <ul class="amenities">
                                            @php
                                                $exAmenities = json_decode($bookData->ameneties, true);
                                            @endphp
