...
<section class="page-wrapper">
    <div class="content container-fluid">
        <!-- Page Header -->
        <!-- /Page Header -->
        @include('user.coach-booking.edit-top-bar',['type' => 'images', 'bookData' => $bookData])
        @include('messages')
       
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form action="{{$updateLink}}" name="event_form" id="event_form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('uploads/'.$bookData->poster_image)}}" class="upimage img-fluid img-thumbnail d-block mb-2" alt="">
                                        <div class="uploader">
                                            <input type="file" name="image" id="image" class="uploader form-control" onchange="prevImage(this)" value="" accept="image/*">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('uploads/'.$bookData->description_image)}}" class="upimage img-fluid img-thumbnail d-block mb-2" alt="">
                                        <div class="uploader">
                                            <input type="file" name="desc_page_img" id="desc_page_img" class="uploader form-control" onchange="prevImage(this)" value="" accept="image/*">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-12" id="add_more_block">
                                    @foreach (json_decode($bookData->coaches_info) as $key => $coach)
                                        <div class="row mb-4 remove_slot_prnt">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <code>Coach Image</code>
                                                    <img src="{{asset('uploads/'.$coach->image)}}" class="upimage img-fluid img-thumbnail d-block mb-2" alt="">
                                                    <div class="uploader">
                                                        <input type="file" name="gallery_image[]" class="uploader form-control" onchange="prevImage(this)" accept="image/*">
                                                        <input type="hidden" name="gallery_image_old[]" value="{{ $coach->image }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="">Coach Name</label>
                                                <input type="text" value="{{$coach->name}}" name="coach_name[]" class="form-control"  placeholder="Coach Name" required>
                                            </div>
                                            <div class="col-md-2">
                                                <label for="">Age</label>
                                                <input type="number" name="coach_age[]" value="{{$coach->age}}" class="form-control"  placeholder=" Age" required>
                                            </div>
                                            <div class="col-md-2">
                                                <label for="">Experience</label>
                                                <input type="text" name="coach_experience[]" class="form-control"  placeholder=" Experience" required value="{{$coach->experience}}">
                                            </div>
                                            @if($key > 0)
                                                <div class="col-md-2">
