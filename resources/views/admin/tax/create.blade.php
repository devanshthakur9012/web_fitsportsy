                            ...
                            <form method="post" action="{{ url('tax') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="ml-0" name="amount_type" type="radio" value="price"
                                        ...
                                        class="form-control @error('amount_type')? is-invalid @enderror" checked>Price
                                    <input class="ml-5" name="amount_type" type="radio" value="percentage"
                                        {{ old('amount_type') == 'percentage' ? 'checked' : '' }}
                                        class="form-control @error('amount_type')? is-invalid @enderror">Percentage
                                    @error('amount_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                {{-- <div class="form-group"> --}}
                                    {{-- <div class="custom-control custom-checkbox"> --}}
                                        <input type="hidden" name="allow_all_bill" value="1" class="custom-control-input" tabindex="3" id="allow_all_bill">
