    ...
    <div class="hawan_section">
        <div class="mt-5 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="h4 mb-0 float-left"> <img width="180px" src="{{asset('/images/CoachTherapist.png')}}" alt="Personal Trainer">  <button class="mx-3 btn social-btn py-2" data-toggle="modal" data-target="#socialPlay">Create</button></div>
