                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="media mb-3">
                                            ...
                                            <div class="media-body">
                                                ...
                                                @if($order->event->event_type=='Particular')
                                                    <div class="media-description text-muted">
                                                        {{ $order->event->start_time->format('l') . ', ' . $order->event->start_time->format('d M Y') }}
                                                    </div>
                                                @elseif($order->event->event_type=='OnDemand')
                                                    <div class="media-description text-muted">OnDemand Puja Seva</div>
                                                @else
                                                    @php
                                                        $days = date("d M Y",strtotime($order->ticket_date)).' ('.$order->ticket_slot.')';
                                                    @endphp
                                                    <div class="media-description text-muted">
                                                        {{ $days }}
                                                    </div>
