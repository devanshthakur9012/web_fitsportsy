            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            @include('messages')
                            <form method="post" class="event-form" action="{{ url('store-event-bulk-upload') }}" id="event_form" name="event_form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Upload Excel File') }} <span class="text-danger">*</span></label>
